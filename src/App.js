    ...
    <div>
      <div className="flex flex-col items-center justify-center h-screen overflow-scroll App">
        <div id='card' className="overflow-hidden rounded-3xl">
          ...
          <div id='card-content' className="flex flex-col p-6 md:p-12">
            <div className='p-2 font-extrabold text-center md:p-0 md:text-3xl' id="header-text">Order Summary</div>
            <div id='content-text' className='p-2 text-center md:p-5 md:font-bold '>
              You can now listen to millions of songs, audiobooks, and podcasts on
              any device anywhere you like!
            </div>
            <div id='plan' className='flex p-4 my-5 md:my-0 md:p-7 rounded-xl'>
              ...
              <div id='plan-change' className='self-center flex-auto font-bold text-right underline transition-colors'><a href='#'>Change</a></div>
            </div>
